...
(function ($) {
	$.fn.addRating = function (options) {
		...
		$(this).append(
			'<span class="count-star"><span id="' + settings.fieldId + '">-</span><input type="text" value="/" name="' + settings.fieldId + '" data-msg-required="Пожалуйста, поставьте оценку.">'
		);
	};
